...
**Claim.** Holding assignment fixed isolates the institutional effect on work outcomes from any effect on work selection.

**Type.** design  **Support.** argued

**Holds when.**

- the matched-condition assignment procedure

**Source quote.**

> Holding assignment fixed isolates the institutional effect on work outcomes from any effect on work selection.

**From.** Wulf A. Kaal, *Empirical Evaluation of the Agentic Reputation Substrate: Deliberation, the Composition of Error, and the Registered Measurement of Agency Costs in a Controlled Multi-Model Cohort* (2026), IV.B. Stage 1: The Benchmark and the Fixed Pairing, page 18

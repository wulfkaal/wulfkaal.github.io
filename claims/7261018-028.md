# kaal:claim:7261018-028

**Claim.** Deliberation should reduce over-approval because the assessment exchange forces the pool to articulate what is wrong with a submission before anyone profits from waving it through.

**Type.** predictive  **Support.** argued

**Holds when.**

- the preregistered mechanism prediction for over-approval

**Source quote.**

> Deliberation should reduce over-approval because the assessment exchange forces the pool to articulate what is wrong with a submission before anyone profits from waving it through.

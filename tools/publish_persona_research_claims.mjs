...
// The 5,033 figure below, and in the record Limit line, the HTML warning, the
// collection description and counts.protected_scholarly_claims_unchanged, is
// FROZEN. It is part of the dated 2026-08-01 release record and is bound by
// authorization.affirmation_sha256. Updating it to the current corpus size would
// rewrite 86 published records and retroactively alter what the author affirmed.
// Republishing at a new count is a re-release decision, not a text edit.
...
console.log(JSON.stringify({
  ...
  scholarly_claim_layer_unchanged: releaseManifest.counts.protected_scholarly_claims_unchanged,

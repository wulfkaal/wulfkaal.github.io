...
5,073-claim corpus into an agent-capability graph. It does not create or affirm
...
CATALOG = {
    ...
    "description": (
        "First-party machine resources for attributable scholarship: the 5,073-claim "

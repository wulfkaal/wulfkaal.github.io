# kaal:position:2026-07-31-7181

**Affirmed position.** Artificial Intelligence for Adjudication presents the following source proposition: What lessons can we draw from the SSA experience for AI in government? This proposition is pertinent to Kaal's source-bound claim that Keeping judges ultimately accountable through a human-in-the-loop review of AI generated reasoning, as practiced in Shenzhen, does not fully resolve the accountability problem in AI assisted adjudication. The proposed response is an extension: the relationship should remain limited to the retrieved source proposition and the mapped Kaal claim unless fuller source review supports a broader conclusion.
...
**Current debate.** Artificial Intelligence for Adjudication: https://doi.org/10.1093/oxfordhb/9780197579329.013.46

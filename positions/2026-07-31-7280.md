...
- Primary mapping confidence: 0.4493.
- The source-to-claim mapping remains explicitly ambiguous and is published with that limitation.

**Current debate.** Human-Centric Explainable AI in Healthcare: A Review of Methods, Evaluation Metrics, and Ethical Governance (Preprint): https://doi.org/10.2196/preprints.89088
...
**Mapping confidence.** 0.4493  **Mapping ambiguous.** true

...
This layer is distinct from the 5,073 scholarly claims extracted from published papers.
...
2,037 of the 5,073 claims describe how a design, mechanism or proposed remedy
...
This is a pilot of 100 claims, not the full 5,073-claim corpus. Absence from a
...
| Surface | URL | Status |
|---|---|---|
| Author-affirmed research claims | https://wulfkaal.github.io/research-claims/trustcarry-protocol/v0.3/index.json | Public, source manuscript unpublished; not in the 5,073 scholarly layer |

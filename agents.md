...
This layer is distinct from the 5,113 scholarly claims extracted from published papers.
...
2,037 of the 5,113 claims describe how a design, mechanism or proposed remedy
...
| Surface | URL | Status |
|---|---|---|
| Author-affirmed research claims | https://wulfkaal.github.io/research-claims/trustcarry-protocol/v0.3/index.json | Public, source manuscript unpublished; not in the 5,113 scholarly layer |
